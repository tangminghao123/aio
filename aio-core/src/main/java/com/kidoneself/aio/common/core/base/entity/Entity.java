package com.kidoneself.aio.common.core.base.entity;

import com.kidoneself.aio.common.core.base.enumeration.Status;
...
/**
 * 包括id、create_time、created_by、updated_by、update_time 字段的表继承的基础实体
 *
 * @author zuihou
 * @date 2019/05/05
 */
